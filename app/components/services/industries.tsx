...
import finance from "@/public/industries/Finance.png"
import manufacturing from "@/public/industries/Manufacturing.png"
import retail from "@/public/industries/Retail.png"
import education from "@/public/industries/Education.png"
...
const AnimatedItem = ({ children, className = "" }: { children: React.ReactNode, className?: string }) => {
    return (
        <motion.div
            variants={fadeInUp}
            className={className}
    ...
    return (
        <div className="min-h-screen bg-[#08060F] text-white pt-24">
            ...
            <AnimatedSection className="max-w-7xl mx-auto px-4 py-16">
                ...
                <div className="overflow-x-auto grid md:grid-cols-2 lg:grid-cols-3">
                    <Image alt="healthcare" src={healthcare}   ></Image>
                    <Image alt="healthcare" src={manufacturing}   ></Image>
                    <Image alt="healthcare" src={retail}   ></Image>
                    <Image alt="healthcare" src={education}   ></Image>
                    <Image alt="healthcare" src={finance}   ></Image>
                </div>
            </AnimatedSection>
            ...
            <AnimatedSection className="max-w-7xl mx-auto px-4 py-16">
                <div className="bg-gradient-to-r from-[#3D43D4] to-[#3D43D4]/80 rounded-2xl p-8 md:p-12 text-center">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        <a href="/contact-us" className="px-8 py-3 bg-white text-[#3D43D4] rounded-lg font-semibold hover:bg-white/90 transition-colors">
                            Start Your Project
                        </a>
                        <a href="/contact-us" className="px-8 py-3 border-2 border-white text-white rounded-lg font-semibold hover:bg-white/10 transition-colors">
                            Schedule a Call
                        </a>
                    </div>
                </div>
