    ...
    useEffect(() => {
        ...
        const handleScroll = () => {
            ...
            if (window.scrollY > 50) {
                header.classList.add('backdrop-blur-md', 'bg-[#08060F]/80', 'shadow-lg');
                header.classList.remove('bg-transparent');
            } else {
                header.classList.remove('backdrop-blur-md', 'bg-[#08060F]/80', 'shadow-lg');
            ...
            <header ref={headerRef} className="z-[100] fixed lg:block top-0 w-full transition-all duration-300 bg-transparent">
                <section className='lg:w-[80vw] xl:w-[60vw] justify-self-center md:h-[4rem] hidden lg:grid grid-flow-col items-center'>
                    ...
                    <div className='justify-self-center flex gap-4'>
                        <Link href="/" className="text-white hover:text-[#3D43D4] transition-colors">Portfolio</Link>
                        ...
                        <Link href="/" className="text-white hover:text-[#3D43D4] transition-colors">Insights</Link>
                    </div>
