...
const LegalDisclaimer = () => (
  <main className={`max-w-3xl mx-auto px-4 py-12 ${roboto.className}`}>
    ...
    <section className="mb-6">
      <h2 className="text-xl font-semibold mb-2">Disclaimer for Seo Master </h2>
      <p className="mb-4">At Seo Master , we believe in being honest and transparent with our visitors. The information you'll find on our website is shared with good intentions and meant for general knowledge purposes only. We always attempt our level best to keep everything accurate and updated, but we do not guarantee or assure the complete accuracy, reliability, or completeness of information on this site.</p>
      <p className="mb-4">Any action you choose to take after reading the information presented on this website is entirely at your own risk. Seo Master will not be responsible for any kind of losses or damages that may occur from using our website.</p>
      ...
      <p className="mb-4">Also, after you leave www.seomaster.com, we request that you recall that other websites have their own terms of use and privacy policies, which are not in our control. Therefore, we recommend that you visit the privacy policies and terms of any site you go to, particularly before sending your personal information or entering into any business transaction with them.</p>
    </section>
    <section className="mb-6">
